...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  var initialAdd = sum(a, b);
  var secondAdd = sum(initialAdd[0], c);
  var initialMultiply = multiply(a, b);
  var secondMultiply = multiply(initialMultiply[0], c);
  var sumAnswerString = a + ' and ' + b + ' and ' + c + ' sum to ' + secondAdd[0] + '.';
  var multiplyAnswerString = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + secondMultiply[0] + '.';
  return [secondAdd[0], secondMultiply[0], sumAnswerString, multiplyAnswerString];
}
...
function sumArray(sumArr) { //eslint-disable-line
  var firstArraySum = sum(sumArr[0], sumArr[1]);
  var secondArraySum = sum(firstArraySum[0], sumArr[2]);
  var sumArrayString = sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + secondArraySum[0] + ' is their sum.';
  return [secondArraySum[0], sumArrayString];
}
